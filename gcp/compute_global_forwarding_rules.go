...
func init() {
	...
	computeResource := ComputeGlobalForwardingRules{
...
// Name - Name of the resourceLister for ComputeGlobalForwardingRules
func (c *ComputeGlobalForwardingRules) Name() string {
	return "ComputeGlobalForwardingRules"
}

// ToSlice - Name of the resourceLister for ComputeGlobalForwardingRules
func (c *ComputeGlobalForwardingRules) ToSlice() (slice []string) {
	return helpers.SortedSyncMapKeys(&c.resourceMap)
}

// Setup - populates the struct
func (c *ComputeGlobalForwardingRules) Setup(config config.Config) {
	c.base.config = config
}

// List - Returns a list of all ComputeGlobalForwardingRules
func (c *ComputeGlobalForwardingRules) List(refreshCache bool) []string {
	if !refreshCache {
		return c.ToSlice()
	}
	...
	listCall := c.serviceClient.GlobalForwardingRules.List(c.base.config.Project)
...
// Remove -
func (c *ComputeGlobalForwardingRules) Remove() error {
	// Removal logic
