...
func init() {
	...
	computeResource := ComputeSSLCertificates{
...
// Name - Name of the resourceLister for ComputeSSLCertificates
func (c *ComputeSSLCertificates) Name() string {
	return "ComputeSSLCertificates"
}

// ToSlice - Name of the resourceLister for ComputeSSLCertificates
func (c *ComputeSSLCertificates) ToSlice() (slice []string) {
	return helpers.SortedSyncMapKeys(&c.resourceMap)
}

// Setup - populates the struct
func (c *ComputeSSLCertificates) Setup(config config.Config) {
	c.base.config = config
}

// List - Returns a list of all ComputeSSLCertificates
func (c *ComputeSSLCertificates) List(refreshCache bool) []string {
	if !refreshCache {
		return c.ToSlice()
	}
	...
	listCall := c.serviceClient.SslCertificates.List(c.base.config.Project)
...
func (c *ComputeSSLCertificates) Dependencies() []string {
	a := ComputeTargetHTTPSProxies{}

	return []string{a.Name()}
}

// Remove -
func (c *ComputeSSLCertificates) Remove() error {
	// Removal logic
