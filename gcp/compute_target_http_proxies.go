...
func init() {
	...
	computeResource := ComputeTargetHTTPProxies{
...
// Name - Name of the resourceLister for ComputeTargetHTTPProxies
func (c *ComputeTargetHTTPProxies) Name() string {
	return "ComputeTargetHTTPProxies"
}

// ToSlice - Name of the resourceLister for ComputeTargetHTTPProxies
func (c *ComputeTargetHTTPProxies) ToSlice() (slice []string) {
	return helpers.SortedSyncMapKeys(&c.resourceMap)
}

// Setup - populates the struct
func (c *ComputeTargetHTTPProxies) Setup(config config.Config) {
	c.base.config = config
}

// List - Returns a list of all ComputeTargetHTTPProxies
func (c *ComputeTargetHTTPProxies) List(refreshCache bool) []string {
	if !refreshCache {
		return c.ToSlice()
	}
	...
	listCall := c.serviceClient.TargetHttpProxies.List(c.base.config.Project)
...
func (c *ComputeTargetHTTPProxies) Dependencies() []string {
...
// Remove -
func (c *ComputeTargetHTTPProxies) Remove() error {
	// Removal logic
